...
$descriptionQuery="SELECT * FROM movies WHERE id='$descriptionId'";
...
if($resultCheckDescriptionQuery>0){
    while($row=mysqli_fetch_array($runDescriptionQuery)){
        ...
        <div>
            <img src="../posters/movies/<?php echo $row['poster']; ?>" alt="">
            <video src="../trailers/movies/<?php echo $row['trailer']; ?>" controls></video>
        </div>
        <div>
