...
<?php
    ...
    ?>
        ...
        <div class="homepage-multiple-movies-slider">
            ...
            <div class="multiple-items">
            <?php
    $sqlComedy = "SELECT * FROM movies WHERE category = 'Comedy';";
    $resultComedy=mysqli_query($conn,$sqlComedy);
    $resultCheckComedy=mysqli_num_rows($resultComedy);
    if($resultCheckComedy>0){
        while($row=mysqli_fetch_array($resultComedy)){
            echo "
            <div>
            <a href='descriptionMovies.php?descMovieId=$row[id]'>";?><img src="../posters/movies/<?php echo $row['poster']; ?>"><?php echo "</a>";?>
            <?php
    ...
    ?>
        ...
        <div class="homepage-multiple-movies-slider">
            ...
            <div class="multiple-items">
            <?php
    $sqlDrama = "SELECT * FROM movies WHERE category = 'Drama';";
    $resultDrama=mysqli_query($conn,$sqlDrama);
    $resultCheckDrama=mysqli_num_rows($resultDrama);
    if($resultCheckDrama>0){
        while($row=mysqli_fetch_array($resultDrama)){
            echo "
            <div>
            <a href='descriptionMovies.php?descMovieId=$row[id]'>";?><img src="../posters/movies/<?php echo $row['poster']; ?>"><?php echo "</a>";?>
            <?php
    ...
    ?>
        ...
        <div class="homepage-multiple-movies-slider">
            ...
            <div class="multiple-items">
            <?php
    $sqlFantasy = "SELECT * FROM movies WHERE category = 'Fantasy';";
    $resultFantasy=mysqli_query($conn,$sqlFantasy);
    $resultCheckFantasy=mysqli_num_rows($resultFantasy);
    if($resultCheckFantasy>0){
        while($row=mysqli_fetch_array($resultFantasy)){
            echo "
            <div>
            <a href='descriptionMovies.php?descMovieId=$row[id]'>";?><img src="../posters/movies/<?php echo $row['poster']; ?>"><?php echo "</a>";?>
            <?php
    ...
    ?>
        ...
        <div class="homepage-multiple-movies-slider">
            ...
            <div class="multiple-items">
            <?php
    $sqlMystery = "SELECT * FROM movies WHERE category = 'Mystery';";
    $resultMystery=mysqli_query($conn,$sqlMystery);
    $resultCheckMystery=mysqli_num_rows($resultMystery);
    if($resultCheckMystery>0){
        while($row=mysqli_fetch_array($resultMystery)){
            echo "
            <div>
            <a href='descriptionMovies.php?descMovieId=$row[id]'>";?><img src="../posters/movies/<?php echo $row['poster']; ?>"><?php echo "</a>";?>
            <?php
    ...
    ?>
        ...
        <div class="homepage-multiple-movies-slider">
            ...
            <div class="multiple-items">
            <?php
    $sqlRomance = "SELECT * FROM movies WHERE category = 'Romance';";
    $resultRomance=mysqli_query($conn,$sqlRomance);
    $resultCheckRomance=mysqli_num_rows($resultRomance);
    if($resultCheckRomance>0){
        while($row=mysqli_fetch_array($resultRomance)){
            echo "
            <div>
            <a href='descriptionMovies.php?descMovieId=$row[id]'>";?><img src="../posters/movies/<?php echo $row['poster']; ?>"><?php echo "</a>";?>
            <?php
    ...
    ?>
        ...
        <div class="homepage-multiple-movies-slider">
            ...
            <div class="multiple-items">
            <?php
    $sqlThriller = "SELECT * FROM movies WHERE category = 'Thriller';";
    $resultThriller=mysqli_query($conn,$sqlThriller);
    $resultCheckThriller=mysqli_num_rows($resultThriller);
    if($resultCheckThriller>0){
        while($row=mysqli_fetch_array($resultThriller)){
            echo "
            <div>
            <a href='descriptionMovies.php?descMovieId=$row[id]'>";?><img src="../posters/movies/<?php echo $row['poster']; ?>"><?php echo "</a>";?>
            <?php
